...
Vagrant.configure("2") do |config|
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/tsinghua_iiis_wgs"
  #   chef.validation_client_name = "tsinghua_iiis_wgs-validator"
  #   chef.validation_key_path = ".chef/tsinghua_iiis_wgs-validator.pem"
  # end
end
